...
begin = '2024-07-09 16:49:00'
end = '2024-07-10 06:19:00'
...
# # Canary Data #looks like the sensor turned off??
...
ax1.set_title(f'Concentration Ramp 2 ({time}-{time_period} averaged), N = {n}', fontsize="15", weight='bold')
...
ax2.set_title(f'Concentration Ramp 2 ({time}-{time_period} averaged), N = {n}', fontsize="15", weight='bold')
ax2.legend()
fig2.tight_layout()
