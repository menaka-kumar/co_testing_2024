...
# Test 2
begin = '2024-07-04 10:27:00'
end = '2024-07-05 16:27:00'
...
for i in range(len(sensor_nm)):
    ...
    begin_sub = ['2024-07-04 11:27:00', '2024-07-04 13:27:00', '2024-07-04 15:27:00', '2024-07-04 21:27:00', '2024-07-04 23:27:00', '2024-07-05 01:27:00']
    end_sub = ['2024-07-04 12:27:00', '2024-07-04 14:27:00', '2024-07-04 16:27:00', '2024-07-04 22:27:00', '2024-07-05 00:27:00', '2024-07-05 02:27:00']
    mean_errors = []
...
# lines = ax2.gca().get_lines()

# legend1 = ax2.legend([lines[i] for i in [0,1]],[lines[i].get_label() for i in [0,1]], loc=1)
# legend2 = ax2.legend([lines[i] for i in [2,3]],[lines[i].get_label() for i in [2,3]], loc=4)
