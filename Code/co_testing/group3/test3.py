...
# Test 3
begin = '2024-08-04 18:30:00'
end = '2024-08-06 01:00:00'
...
ax1.set_title(f'Effect of RH and T at ~8ppm CO ({time} {time_period} averaged)', fontsize = tick_size)
...
ax2.set_title(f'Effect of RH and T ({time}-{time_period} averaged) at ~8ppm of CO', fontsize="15", weight='bold')
...
for i in range(len(sensor_nm)):
    ...
    begin_sub = ['2024-08-04 19:30:00', '2024-08-04 21:30:00', '2024-08-04 23:30:00', '2024-08-05 05:30:00', '2024-08-05 07:30:00', ]
    end_sub = ['2024-08-04 20:30:00', '2024-08-04 22:30:00', '2024-08-05 00:30:00', '2024-08-05 06:30:00', '2024-08-05 08:30:00', ]
    mean_errors = []
